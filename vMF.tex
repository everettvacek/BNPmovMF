...
The variance of these elements will be over much different ranges, but vMF is univariate and expect normal distributions. To deal with this we scale our data using a robust scaler. Robust scaler preprocessing rescales element values to the interquartile range.
\end{frame}
...
\begin{frame}{Cluster correlation.}
\begin{figure}
    \centering
